...
export const TBK_STORE_LINK_TURNS_OVER_PROVIDE = "TBK_STORE_LINK_TURNS_OVER_PROVIDE"
export const TBK_STORE_LINK_TURNS_OVER_CLICKED = "TBK_STORE_LINK_TURNS_OVER_CLICKED"
export const TBK_STORE_LINK_TURNS_OVER_COPIED = "TBK_STORE_LINK_TURNS_OVER_COPIED"
...
export type RegisterUserCallback = (error: Error | null, userId?: number, cookieValue?: string) => void;
export type StartConversationCallback = (error: Error | null, conversationId?: number, greeting?: string, startTime?: string) => void;
...
export const useUserStore = createPersistStore(
    ...
    (set, get) => ({
        ...
        async registerUser(name: string, gender: string, callback: RegisterUserCallback) {
            ...
            fetch(path, payload)
              ...
              .then((res: any) => {
                  ...
                  set({ userId: user_id, cookieValue: cookie_value, userName: name, gender: gender });
        ...
        async fetchUserInfo(cookieValue: string) {
            ...
            const path = "/api/foodinko/user/authenticate_user" + (cookieValue ? `/${cookieValue}` : "");
            ...
            .then((res: any) => {
                ...
                console.log("[user.ts] fetchUserInfo gender: " + get().gender + ", userName: " + get().userName + ", userId: " + get().userId);
            }
            )
            .catch((err) => {
        ...
        async startConversation(callback: StartConversationCallback) {
            ...
            fetch(path, payload)
              ...
              .then((res: any) => {
                  ...
                  set({ conversationId: conversation_id, greeting: greeting, startTime: start_time});
